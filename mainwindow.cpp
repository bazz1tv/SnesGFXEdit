...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent)
{
	...
	//mdiArea->setFixedHeight(mdiArea->height()+100);
...
{
	// Display dialog box to set new file params.
	// then create new editor with certain constructor params
	// rows, cols, bpp*, size in bytes
	// default is $4000 words, 32x16 grid
...
void MainWindow::openFile(const QString &fileName)
{
    ...
    if (editor)
	{
		//editor->setWindowIcon(QPixmap(":/images/document.png"));
        addEditor(editor);
	}
}
...
/*void MainWindow::showEvent ( QShowEvent * event )
{
	...
	if (activeEditor())
	{
		...
		activeEditor()->view->resize(geometry().width(),geometry().height());
	}
		//activeEditor()->scene->setSceneRect(geometry());
}*/

void MainWindow::setZoom(int id)
{
	Editor *editor = activeEditor();
...
{	
	// Zoom widgets
	zoomButton1 = new QRadioButton("1:1", this);
	zoomButton2 = new QRadioButton("2:1", this);
	zoomButton3 = new QRadioButton("4:1", this);
	// Cursor widgets
	cursorButton1 = new QRadioButton("8x8", this);
	cursorButton2 = new QRadioButton("16x16", this);
	cursorButton3 = new QRadioButton("32x32", this);
	cursorButton4 = new QRadioButton("64x64", this);
	// QButtonGroup
	zoomButtonGroup = new QButtonGroup(this);
	zoomButtonGroup->addButton(zoomButton1);
	zoomButtonGroup->setId(zoomButton1,1);
	zoomButtonGroup->addButton(zoomButton2);
	zoomButtonGroup->setId(zoomButton2,2);
	zoomButtonGroup->addButton(zoomButton3);
	zoomButtonGroup->setId(zoomButton3,4);
	//
	cursorButtonGroup = new QButtonGroup(this);
	cursorButtonGroup->addButton(cursorButton1);
	cursorButtonGroup->setId(cursorButton1, 1);
	cursorButtonGroup->addButton(cursorButton2);
	cursorButtonGroup->setId(cursorButton2, 2);
	cursorButtonGroup->addButton(cursorButton3);
	cursorButtonGroup->setId(cursorButton3, 4);
	...
	// Cursor Signals
	connect(cursorButtonGroup, SIGNAL(buttonClicked(int)), this, SLOT(updateCursor(int)));
...
void MainWindow::createToolBars()
{
	...
	zoomToolBar->addWidget(zoomButton1);
	zoomToolBar->addWidget(zoomButton2);
	zoomToolBar->addWidget(zoomButton3);
	cursorToolBar = addToolBar(tr("Cursor"));
	cursorToolBar->addWidget(cursorButton1);
	cursorToolBar->addWidget(cursorButton2);
	cursorToolBar->addWidget(cursorButton3);
	cursorToolBar->addWidget(cursorButton4);
